      ...
      children: [
        {
          ...
          name: 'Imóveis',
          children: [
            { id: '1-1', href: '/real-estate-categories/all', name: 'Quero Alugar' },
            { id: '1-2', href: '/real-estate-categories/all', name: 'Quero Comprar' },
            { id: '1-3', href: '/real-estate-categories/all', name: 'Lançamentos' },
            { id: '1-4', href: '/financiamento', name: 'Financiar um imóvel' },
            { id: '1-5', href: '/anunciar', name: 'Anunciar meu imóvel' },
          ],
        },
        {
          id: '2',
          ...
          name: 'A imobiliária',
          children: [
            { id: '2-1', href: '/quem-somos', name: 'Quem somos' },
            { id: '2-2', href: '/blog', name: 'Blog' },
            { id: '2-3', href: '/servicos', name: 'Serviços' },
            { id: '2-4', href: '/contato', name: 'Contato' },
            { id: '2-5', href: '/central-atendimento', name: 'Central de Atendimento' },
            { id: '2-6', href: '/trabalhe-conosco', name: 'Trabalhe Conosco' },
            { id: '2-7', href: '/fale-conosco', name: 'Fale Conosco' },
          ],
        },
        {
          id: '3',
          ...
          children: [
            { id: '3-1', href: '/cadastro', name: 'Cadastro' },
            { id: '3-2', href: '/fale-conosco', name: 'Fale Conosco' },
            { id: '3-3', href: '/segunda-via-boleto', name: '2ª via boleto' },
            { id: '3-4', href: '/area-do-cliente', name: 'Área do cliente' },
          ],
        },
        {
          id: '4',
          ...
          name: 'Unidades',
          children: [
            { id: '4-1', href: '/unidades/matriz-centro', name: 'Matriz Centro' },
            { id: '4-2', href: '/unidades/vila-sao-francisco', name: 'Unidade Vila São Francisco' },
            { id: '4-3', href: '/unidades/assis-vila-ayrosa', name: 'Unidade Assis – Vila Ayrosa' },
            { id: '4-4', href: '/unidades/caravana', name: 'Unidade Caravana' },
          ],
        },
      ],
    },
